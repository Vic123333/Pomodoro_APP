...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        high_score.config(text="hard work pays off")
...
check_label = Label(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 13))
check_label.grid(row=3, column=1)

high_score = Label(fg=GREEN, font=(FONT_NAME, 23), bg=YELLOW)
high_score.grid(row=0, column=3)
